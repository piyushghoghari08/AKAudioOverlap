//
//  AudioRecord2ViewController.swift
//  AudioMixDemo
//
...
class AudioRecord2ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        self.navigationController?.title = "Record Audio 2"
    ...
    @IBAction func nextButtonClick(_ sender: UIControl) {
        ...
        let objudioMergeVC = self.storyboard?.instantiateViewController(withIdentifier: "AudioMergeViewController")as! AudioMergeViewController
        objudioMergeVC.audioRecord1URL = audioRecord1URL
        objudioMergeVC.audioRecord2URL = tempAudioURl
        self.navigationController?.pushViewController(objudioMergeVC, animated: true)
...
extension AudioRecord2ViewController: AVAudioRecorderDelegate, AVAudioPlayerDelegate {
    //----------------------------
    ...
    func finishAudioRecording(success: Bool){
        if success{
            ...
            print("audioURL2: -> \(recordAudioURL)")
